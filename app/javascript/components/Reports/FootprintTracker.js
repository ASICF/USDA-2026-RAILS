...
export default function FootprintTracker({ uploads, token }) {
  ...
  console.log("Footprint Tracker", { data, upload });
  ...
  return (
    <div>
      <Breadcrumbs>
        ...
        <Breadcrumb.Divider />
        <Breadcrumb.Section active>Footprint Tracker</Breadcrumb.Section>
      </Breadcrumbs>
        ...
        <Table celled selectable sortable textAlign="center">
          <Table.Header>
            ...
            <Table.Row>
              <Table.HeaderCell
                sorted={
                  column === "pis_that_need_footprints" ? direction : null
                }
                onClick={() =>
                  dispatch({
                    type: "CHANGE_SORT",
                    column: "pis_that_need_footprints",
                  })
                }
              >
                Missing PIs
              ...
              <Table.HeaderCell
                ...
                onClick={() =>
                  dispatch({ type: "CHANGE_SORT", column: "total_photo_indices" })
                }
              >
                Total
              </Table.HeaderCell>
            ...
            {data.map((record) => {
              return (
                ...
                >
                  ...
                  <Table.Cell>{record.pis_that_need_footprints}</Table.Cell>
                  <Table.Cell>{record.pis_with_footprints}</Table.Cell>
                  <Table.Cell>{record.total_photo_indices}</Table.Cell>
                </Table.Row>
              );
            })}
          </Table.Body>
