...
const DoqqTimeline = ({ records, searchInput }) => {
  ...
  if (data.length === 0) {
    return (
      <MessageBox title={"Doqqs"} message={"No records matched search text"} />
    );
  }
      ...
      <Table unstackable sortable celled striped>
        <Table.Header>
          ...
          <Table.HeaderCell
            ...
            <Table.HeaderCell
              sorted={column === "qq_apfo_name" ? direction : null}
              onClick={() =>
                dispatch({ type: "CHANGE_SORT", column: "qq_apfo_name" })
              }
            >
              QQ Apfo Name
            </Table.HeaderCell>
            ...
            return (
              <Table.Row key={record.id} textAlign="center">
                 <Table.Cell>
                  ...
                  <Table.Cell>
                    <RenderValue value={record.qq_apfo_name} />
                  </Table.Cell>
                  <Table.Cell>
