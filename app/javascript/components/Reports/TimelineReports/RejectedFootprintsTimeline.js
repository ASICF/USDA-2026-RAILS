...
const RejectedFootprintsTimeline = ({ records, searchInput }) => {
  ...
  if (data.length === 0) {
    return (
      <MessageBox title={"Rejected Footprints"} message={"No records matched search text"} />
    );
  }
      ...
      <Table unstackable sortable celled striped>
        <Table.Header>
          <Table.Row>
            ...
            >
              <Header>Rejected Footprints</Header>
            </Table.HeaderCell>
          </Table.Row>
        </Table.Header>
        ...
        <Table.Header>
          ...
          <Table.HeaderCell
            ...
            <Table.HeaderCell
              ...
              onClick={() =>
                dispatch({ type: "CHANGE_SORT", column: "centroid_longitude" })
              }
            >
              Centroid Longitude
            </Table.HeaderCell>
            ...
            <Table.HeaderCell
              sorted={column === "rejection_date" ? direction : null}
              onClick={() =>
                dispatch({ type: "CHANGE_SORT", column: "rejection_date" })
              }
            >
              Rejection Date
            </Table.HeaderCell>
            ...
            <Table.HeaderCell
              sorted={column === "rejection_type" ? direction : null}
              onClick={() =>
                dispatch({ type: "CHANGE_SORT", column: "rejection_type" })
              }
            >
              Rejection Type
            </Table.HeaderCell>
            ...
            <Table.HeaderCell
              sorted={column === "reported_date" ? direction : null}
              onClick={() =>
                dispatch({ type: "CHANGE_SORT", column: "reported_date" })
              }
            >
              Reported Date
            </Table.HeaderCell>
            ...
            return (
              <Table.Row key={record.id} textAlign="center">
               <Table.Cell>
                ...
                <Table.Cell>
                  <RenderValue value={record.reported_date} />
                </Table.Cell>
                <Table.Cell>
...
export default RejectedFootprintsTimeline;
