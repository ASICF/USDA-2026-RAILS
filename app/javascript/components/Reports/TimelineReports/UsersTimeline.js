...
const UsersTimeline = ({ records, searchInput }) => {
  ...
  if (data.length === 0) {
    return (
      <MessageBox title={"Users"} message={"No records matched search text"} />
    );
  }
      ...
      <Table unstackable sortable celled striped>
        ...
        <Table.Header>
          ...
          <Table.Cell>
                  ...
                  <Table.Cell>
                    <RenderValue value={record.first_name} />
                  </Table.Cell>
                  <Table.Cell>
                    <RenderValue value={record.last_name} />
                  </Table.Cell>
          </Table.Row>
        </Table.Header>
        <Table.Body>
