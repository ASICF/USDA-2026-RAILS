class FinalDelivery < ApplicationRecord
    ...
    def self.pass_to_validation
        ...
        input_directory = "P:\\Vol_3\\24-6567_USDA_SL\\03_FrameBase\\NC\\Tiles_Dump\\Final_Delivery_20240810_NC"
        # P:\Vol_3\24-6567_USDA_SL\03_FrameBase\NC\Tiles_Dump\Final_Delivery_20240810_NC

        packing_slip = PackingSlip.find_by(name: "20240810_NC")
    ...
    def self.fix_splits
        ...
        split_folder = "/vol3/24-6567_USDA_SL/03_FrameBase/NC/Tiles_Dump/Big_Tiles/"

        # Set the Final Delivery Folder
        final_delivery_folder = "/vol3/24-6567_USDA_SL/03_FrameBase/NC/Tiles_Dump/Final_Delivery_20240810_NC/"
    ...
    def self.build_tile_index
        ...
        geotag_path = "/vol3/24-6567_USDA_SL/03_FrameBase/NC/Tiles_Dump/Final_Delivery_20240810_NC/SL/"
        ...
        Dir.glob("#{geotag_path}/*").each do |folder|
            ...
            # ["/vol2/226567_14_SL_NY/04_TilesDump/Final_Delivery_20221130_NY/SL/NC/36051/"].each do |county_folder|
