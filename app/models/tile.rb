class Tile < ApplicationRecord
    ...
    def self.find_potential_coverages
        ...
        f = File.open("/media/sf_shared/2026/Audit/overview.csv", "w+")
        f.puts "PolyID, State, MultipleGeom, Coverage, RejectionCount\n"

        c = File.open("/media/sf_shared/2026/Audit/potential_coverages.csv", "w+")
        c.puts "PolyID, State, FlightDate, StripFrame, FlownBy\n"

        r = File.open("/media/sf_shared/2026/Audit/potential_rejections.csv", "w+")
